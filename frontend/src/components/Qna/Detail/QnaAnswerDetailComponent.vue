    ...
    <div class="mb-10" v-if="qnaAnswer.userId === 0">
        <div class="mantine-2j9uwr">
            <div class="mantine-1uguyhf">
                <a class="mantine-Avatar-root mantine-18l6s09">
                    <img
                        class="gemini-image mantine-Avatar-image"
                        :src="qnaAnswer.profileImage" />
                </a>
                <div class="mantine-Stack-root mantine-1l47z8p">
                    <div class="mantine-824czz">
                        <p class="mantine-Text-root mantine-3qdwx9 answer-name-text">
                            Gemini
                        </p>
                    </div>
    ...
    <div class="mb-10" v-else>
      <div class="mantine-2j9uwr">
        <div class="mantine-1uguyhf">
          ...
          <div class="mantine-Stack-root mantine-1l47z8p">
            <div class="mantine-824czz">
              <a class="mantine-Text-root mantine-3qdwx9 answer-name-text">
    ...
    <div>
      ...
      <div class="mt-auto pt-10">
        <div class="flex flex-col md:flex-row gap-5 justify-start">
          <a href="https://github.com/bentoml/rag-tutorials"
              target="_blank"
              rel="noopener noreferrer"></a>
          <a href="https://docs.bentoml.com/"
            target="_blank"
