<template>
  <div id="__next" :class="{ 'loading': isLoading }">
    ...
    <LoadingComponent v-show="isLoading" style="margin-top: 10rem"/>
    <div class="my-4 lg:my-0 px-6 max-w-4xl mx-auto">
      <div class="my-4 flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
        ...
        <div class="flex-grow lg:mt-0 lg:shrink-0 lg:grow-0">
          <div class="mt-6">
            <p class="text-xl font-medium text-gray-700 dark:text-gray-300 text-center mb-4"
               aria-hidden="true">
              프로필 사진
            </p>
...
export default {
  ...
  components: { LoadingComponent, PasswordModal },
  data() {
    return {
      isLoading: false,
  ...
  mounted() {
    ...
    this.mypageStore.fetchUserInfo().then(() => {
