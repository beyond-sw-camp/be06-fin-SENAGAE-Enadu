            ...
            <div class="sc-TBWPX dXONqK sc-jQrDum fiOuRZ">
                <div class="head-wrapper">
                    ...
                    <div class="sc-fvxzrP jGdQwA" style="display: flex; justify-content: space-between;">
                        ...
                        <div class="information">
                            ...
                            <span class="username"><NicknameComponent
                                :nickname="errorarchiveStore.errorArchiveDetail.nickname"/>
                </span>
                            <span class="separator">·</span>
                            <span style="font-size:16px">{{ lastModifiedDate }}</span>
                            <span style="font-size:16px" :class="['grade', dynamicClass]">{{
                                    errorarchiveStore.errorArchiveDetail.grade
                                }}</span>
                        </div>
                                ...
                                <label for="bookmark-toggle" class="bookmark-checkbox__label">
                                    <svg data-v-00557fae="" class="bookmark-checkbox__icon" viewBox="0 0 24 24">
                                        <path data-v-00557fae="" class="bookmark-checkbox__icon-back"
                                              ...
                                              stroke="#767676"></path>
                                        <path data-v-00557fae="" class="bookmark-checkbox__icon-check" d="M8 11l3 3 5-5"
                                              stroke-width="1.5" stroke="#767676"></path>
                                    </svg>
                                </label>
                            </div>
                            ...
                            <div class="icons-box">
                                <div class="icons">
                                    <label class="btn-label" for="like-checkbox">
                                        ...
                                        <input class="input-box" id="like-checkbox" type="radio" value=true
                                ...
                                <div class="icons">
                                    <label class="btn-label" for="dislike-checkbox">
                                        <input
                                            class="input-box"
                                            id="dislike-checkbox"
                                            type="radio" name="like" v-model="selectedLike" value=false
                ...
                <div class="category-edit-div">
                    <div class="sc-cZMNgc bpMcZw">
                        <CategoryComponent v-if="errorarchiveStore.errorArchiveDetail.superCategory !== null"
                                           :category=errorarchiveStore.errorArchiveDetail.superCategory />
                        <CategoryComponent v-if="errorarchiveStore.errorArchiveDetail.subCategory !== null"
                                           :category=errorarchiveStore.errorArchiveDetail.subCategory :is-sub="true"/>
                    </div>
