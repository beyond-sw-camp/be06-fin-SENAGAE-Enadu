                                ...
                                <div class="grid grid-cols-1 gap-y-7">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <div class="flex w-full">
                                            <input type="text" id="category" placeholder="상위 카테고리를 선택해주세요." disabled
                                    ...
                                    <!-- 썸네일 등록 -->
                                    <div class="space-y-1">
                                        <label for="thumbnail" class="text-sm font-medium text-gray-700 dark:text-gray-300">썸네일 등록</label>
                                        <div class="flex w-full">
                                            <input type="file" id="thumbnail" name="thumbnail"
                                                class="block w-full appearance-none rounded-md border border-gray-500/30 pl-3 pr-3 py-2 text-base placeholder-gray-500/80 shadow-sm focus:border-gray-500 focus:outline-none focus:ring-0 dark:bg-gray-500/20"
                                                accept="image/*" ref="thumbnailInput">
                                            <button type="button" id="clearThumbnail"
                                                class="ml-3 w-20 items-center space-x-2 rounded-md bg-red-500 px-4 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-600" @click="clearThumbnail">
                                                취소
                                            </button>
                                        </div>
                                    </div>
